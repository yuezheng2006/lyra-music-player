...
export default {
  ...
  "options": {
    ...
    "enableSmartAtmosphereDesc": "根据节拍与歌曲情绪驱动背景呼吸、粒子和电影感缩放。",
    "interactive3dSceneSettings": "3D 场景",
    "interactive3dSceneSettingsDesc": "按组件开关 3D 背景层，并与歌词共用同一套节奏曲线。",
    "interactive3dWebglOnlyDesc": "当前 3D 交互由 WebGL 视觉风格驱动；高级分层开关已隐藏，避免无效组合。",
    ...
    "interactive3dEffectBloomParticlesDesc": "柔光粒子层，增强封面丝绸感。",
    ...
    "interactive3dEffectCoverParticlesDesc": "封面/骷髅点云主背景。",
