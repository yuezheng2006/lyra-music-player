...
export default {
  ...
  "commandPalette": {
    ...
    "commands": {
      ...
      "navigate-player": { "title": "听歌模式", "description": "进入沉浸播放页" },
      "navigate-back-playlist": { "title": "回到歌单", "description": "从听歌模式返回歌单卡片页" },
  ...
  "home": {
    ...
    "qishuiProvider": "汽水音乐",
    "qishuiProviderHint": "粘贴分享链接解析播放",
    "cocoProvider": "Coco",
    "cocoProviderHint": "公开聚合搜索与试听",
    "cocoDefaultDescription": "公开聚合搜索与试听",
    "sectionSearch": "搜索",
  ...
  "search": {
    ...
    "subtitleQishui": "汽水音乐暂不支持关键词搜索，请粘贴 qishui.douyin.com 分享链接解析播放",
    "subtitleCoco": "公开聚合搜索，输入歌名、歌手或专辑即可试听",
  ...
  "options": {
    ...
    "autoHidePlayerChromeDesc": "开启后，鼠标离开窗口约 3 秒会自动隐藏播放页底栏与右侧面板按钮。也可按 H 键切换。",
