...
export default {
  ...
  "commandPalette": {
    ...
    "commands": {
      ...
      "settings-integration": { "title": "Integration settings", "description": "Open music account, Stage, Now Playing, and Navidrome settings" },
  ...
  "options": {
    ...
    "lyricColorPresetDesc": "Applies colors plus glow/rhythm emphasis. Font stays independent.",
    "lyricColorPreset": {
      "midnightDefault": "Default White",
      "douyinNeon": "Douyin Neon",
      "douyinPurple": "Douyin Purple",
      "xhsMorandi": "XHS Morandi",
      "dazibaoRed": "Wildfire Red"
    },
