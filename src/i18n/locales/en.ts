...
export default {
  ...
  "queue": {
    "empty": "No requested tracks",
    "title": "Requested",
    "shuffle": "Shuffle Queue",
    "autoSeedToast": "Added {{count}} tracks from the current playlist to Requested",
    "autoSeedBanner": "Auto-filled from the current playlist · separate from the play queue",
    "autoSeedBadge": "New"
  },
  "theme": {
