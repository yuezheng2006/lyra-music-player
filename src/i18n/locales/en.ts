...
export default {
  ...
  "commandPalette": {
    ...
    "commands": {
      ...
      "navigate-player": { "title": "Listening mode", "description": "Enter the immersive player view" },
  ...
  "account": {
    ...
    "coco": "Coco",
    "cocoAvailable": "No login · Free to use",
    "cocoHint": "Public aggregated search and preview",
    "qqMusic": "QQ Music",
  ...
  "home": {
    ...
    "searchQishuiMusic": "Paste a Qishui Music share link...",
    ...
    "qishuiProviderHint": "Paste a share link to resolve playback",
    "cocoProvider": "Coco",
    "cocoProviderHint": "Public aggregated search & preview",
    "cocoDefaultDescription": "Public aggregated search & preview",
  ...
  "search": {
    ...
    "subtitleQishui": "Qishui does not support keyword search yet. Paste a qishui.douyin.com share link to resolve playback",
    "subtitleCoco": "Public aggregated search — type a song, artist, or album to preview",
  ...
  "options": {
    ...
    "autoHidePlayerChromeDesc": "When enabled, the docked player bar and right-side panel button auto-hide after the mouse leaves the window for about 3 seconds. You can also press H.",
  ...
  "localMusic": {
    ...
    "rescanChooseFolder": "Choose a folder to rescan",
    ...
    "resyncFailed": "Failed to rescan folder. Please try again.",
