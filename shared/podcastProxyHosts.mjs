...
export const isPrivatePodcastProxyHostname = (hostname) => {
...
export const isApplePodcastCatalogHost = (hostname) => {
...
export const isAllowedPodcastProxyUrl = (urlString) => {
