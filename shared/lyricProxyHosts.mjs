// shared/lyricProxyHosts.mjs
// Host allowlist for lyric/cover proxy (ESM).

export function isAllowedLyricProxyHost(hostname) {
...
export function isAmllDbHost(hostname) {
...
export function resolveCoverProxyReferer(url) {
  try {
