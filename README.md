...
| Linux Deb | [lyra-music-player-1.0.2-linux-amd64.deb](https://github.com/yuezheng2006/lyra-music-player/releases/download/v1.0.2/lyra-music-player-1.0.2-linux-amd64.deb) |
| Linux RPM | [lyra-music-player-1.0.2-linux-x86_64.rpm](https://github.com/yuezheng2006/lyra-music-player/releases/download/v1.0.2/lyra-music-player-1.0.2-linux-x86_64.rpm) |
| Linux 通用 | [lyra-music-player-1.0.2-linux-x64.tar.gz](https://github.com/yuezheng2006/lyra-music-player/releases/download/v1.0.2/lyra-music-player-1.0.2-linux-x64.tar.gz) |
