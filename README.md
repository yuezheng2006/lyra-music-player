...
[桌面版下载](https://github.com/yuezheng2006/lyra-music-player/releases/tag/v1.0.3)
·
...
演示视频待补。桌面安装包见 [Releases v1.0.3](https://github.com/yuezheng2006/lyra-music-player/releases/tag/v1.0.3)。

## 桌面端下载

| 平台 | 文件 |
| --- | --- |
| macOS Apple Silicon | [Lyra-1.0.3-arm64.dmg](https://github.com/yuezheng2006/lyra-music-player/releases/download/v1.0.3/Lyra-1.0.3-arm64.dmg) |
| macOS Intel | [Lyra-1.0.3-x64.dmg](https://github.com/yuezheng2006/lyra-music-player/releases/download/v1.0.3/Lyra-1.0.3-x64.dmg) |
| Windows | [Lyra-Setup-1.0.3.exe](https://github.com/yuezheng2006/lyra-music-player/releases/download/v1.0.3/Lyra-Setup-1.0.3.exe) |
| Linux Deb | [lyra-music-player-1.0.3-linux-amd64.deb](https://github.com/yuezheng2006/lyra-music-player/releases/download/v1.0.3/lyra-music-player-1.0.3-linux-amd64.deb) |
| Linux RPM | [lyra-music-player-1.0.3-linux-x86_64.rpm](https://github.com/yuezheng2006/lyra-music-player/releases/download/v1.0.3/lyra-music-player-1.0.3-linux-x86_64.rpm) |
| Linux 通用 | [lyra-music-player-1.0.3-linux-x64.tar.gz](https://github.com/yuezheng2006/lyra-music-player/releases/download/v1.0.3/lyra-music-player-1.0.3-linux-x64.tar.gz) |
